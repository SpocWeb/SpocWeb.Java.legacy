...
*/
	...
	public static void testIt() {
		...
		char[][] Edges ={{'A','G', (char) 4},
						 ...
						 {'A','F', (char) 2},
						 {'G','E', (char) 1}};
		char[][] Edges2={{'G','C', (char) 1},	//neu f�r zweifachen Zusammenhang
						 {'H','G', (char) 3},
						 {'G','J', (char) 1},
						 {'L','G', (char) 5}};
		char[][] Edges5={{'I','H', (char) 1},	//neu f�r gerichtete Graphen
						 {'M','L', (char) 1}};
		char[][] Edges3={{'G','C', (char) 1},	//neu f�r k�rzeste Wege und Spannbaum
						 {'A','C', (char) 1},	//Werte l�schen einfach den schon gesetzten Weg!
						 {'A','G', (char) 6},		//Entfernung �ndern!
						 {'H','I', (char) 2},		//Entfernung �ndern!

						 {'B','D', (char) 2},		//hier kommen die neuen Verbingungen
						 {'B','E', (char) 4},		//f�r den ungerichteten gewichteten Graphen
						 {'B','C', (char) 1},
						 {'C','E', (char) 4},
						 {'E','L', (char) 4},
						 {'F','L', (char) 2},
