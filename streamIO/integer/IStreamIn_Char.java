...
/**
 * Extends {@link IStreamIn_Byte} with {@code java.io.Reader}-style character-reading
 * operations, separating character- and encoding-related concerns from the purely
 * byte-oriented Methods of its superinterface.
 *
 ...
 * @author heuerm
 * @version	1.0
 * @see IStreamIn_Byte byte-oriented superinterface extended here
 * <!-- docstate
