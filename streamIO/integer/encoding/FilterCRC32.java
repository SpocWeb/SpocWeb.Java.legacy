...
/**
  ...
  *
  * The 32-bit CRC (Cyclic Redundancy Check) is a specific kind of checksum.
  ...
  * This would then be divided by the divisor polynomial,
  * resulting in the equation:
  *
  *        1x7 + 1x6 + 1x0
  * CRC = ____________________
  *        x16 x15 + X2 + 1
  *
...
////////////////////////////////////////////////////////////////////////////////
	...
	/**
	  ...
	  */
	public static int updateCRC32(int CRC, byte bytByte) {
		int index = (CRC ^ bytByte) & 0xFF; 	//Calculate the Index
		return (CRC >>> 8) ^ CRC32[index]; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	protected int CRC = ~0;// = 0xFFFFFFFF;
...
////////////////////////////////////////////////////////////////////////////////
	...
	public FilterCRC32(IStreamOutByte streamOut) {
		super(streamOut); }
	 ...
	 */
	public FilterCRC32(OutputStream streamOut) {
		super(streamOut); }

	/** Initializing Constructor taking a IStreamIn_Byte 	 */
	public FilterCRC32(IStreamIn_Byte streamIn_) {
		super(streamIn_); }
	 ...
	 * and declared to implement IStreamIn_Byte!
	 */
	public FilterCRC32(InputStream streamIn_) {
		super(streamIn_); }
...
////////////////////////////////////////////////////////////////////////////////
	...
	public void write(int b) throws IOException {
		CRC = updateCRC32(CRC, (byte) b); //super.write(b);
		if (streamOut != null)
			streamOut.write(b); 
	}
...
////////////////////////////////////////////////////////////////////////////////
	...
	public static void testIt(String[] args) throws java.io.IOException {
		System.out.println("Testing " + FilterCRC32.class.getName());
		String strTest = "One small step for [a] man; one giant leap for mankind";
		byte[] byteTest = strTest.getBytes();
//		int CRC = 252857110;
		FilterCRC32 enc = new FilterCRC32(System.out);
		enc.write(byteTest);//strTest); //
//		enc.close();    //
		System.out.println("\nCRC-Value:" + enc.getCRC());
		enc = new FilterCRC32(System.out);
		byteTest[20] = (byte) 228;
		enc.write(byteTest);//strTest); //
		System.out.println("\nCRC-Value:" + enc.getCRC());
	}
