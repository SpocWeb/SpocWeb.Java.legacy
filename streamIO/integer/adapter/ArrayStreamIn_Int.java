...
/**
 * Adapts a primitive {@code int[]} or {@code long[]} array to the {@code IStreamIn_Int}
 * sequential-read contract, offering mark/reset positioning and bounds-checked
 * iteration over the wrapped array without copying its contents.
 *
