 ...
 * Mehr als 60 Prozent unserer m�ndlichen �u�erungen bestehen aus Konsonanten 
 ...
 * Die 50 meistgebrauchten W�rter einer (jeden) Sprache 
 * machen etwa 45 % jedes geschriebenen Textes aus.
 * 
 * Die ersten 15 W�rter machen 25% des Textes aus, 
 * die ersten 100 W�rter 60 % und 
 * die ersten Tausend 85 %. 
 * Mit den ersten 4.000 sind dann 97,5 % des Textes erfa�t. 
 * 
 * Die mittlere Wortl�nge und Satzl�nge k�nnen relativ einfach berechnet werden. 
 * Die Wortl�nge ist der Quotient aus der Gesamtzahl der Buchstaben und der Anzahl der Leerzeichen in einem Text. 
 * Die Satzl�ge berechnet sich aus der Gesamtzahl der Buchstaben 
 * geteilt durch die Anzahl der Satzzeichen (mittlere Buchstabenanzahl in einem Satz) 
 * und geteilt durch die mittlere Wortl�nge (mittlere Wortanzahl in einem Satz).
 * 
