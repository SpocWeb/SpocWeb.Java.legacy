 ...
 * digest: 29cdeeed7aba6cc57aec7cb858f865550995dd73e284eea9d203f7605866b4b7
 * stale: true
 ...
 * -->
 */
public class ArrayEnumPrimitive
extends AIndexEnumerator {
	...
	public ArrayEnumPrimitive(final Object arr_, final int Length_) {
		super(null); 
		this.Length = Length_;
		this.arr = arr_; }

	/** Initializing Constructor     */
	public ArrayEnumPrimitive(Object arr) {
...
//		arr[arr.length - 1] = null; //Set the last Item to null to enforce Garbage Collection.
	...
	public Enumerator Enumerator() { //return null; }
		return new ArrayEnumPrimitive(arr); }

	/** Returns a new Intstance of a ChangeIterator,
	  * which allows for changing the Data concurrently. */
	public ChangeIterator ChangeIterator() { return new ArrayEnumPrimitive(arr); }
