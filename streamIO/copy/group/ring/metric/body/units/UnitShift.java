...
/** Constant for   */
final static public UnitShift Celsius = new UnitShift(Unit.Celsius0);
...
/** Empty Constructor	 */
public UnitShift(final double shift_) {
	super();
	mShift = shift_; }
...
public double Map(double arg) {
	...
	return mBaseUnit.Map(arg + mShift); }

/**Returns the Function Value (mapping) of the Argument arg */
public float Map(float arg) {
	if (mBaseUnit == this) return arg;
	return mBaseUnit.Map((float) (arg + mShift)); }
...
public static void testIt(String[] args) throws IOException {
	System.out.println("Testing " + UnitShift.class.getName());
}
