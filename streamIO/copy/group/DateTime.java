 ...
 *				  In diesem Zyklus sind 11 Schalttage gleichm‰ﬂig verteilt.
 ...
 *
 * Der Kalender der franzoesischen Revolution (calendrier rÈpublicain)
 *
 ...
 * zusammengefasst (z.B. NivÙse,PluviÙse, VentÙse). Ein Monat setzte sich aus drei
 ...
 * Tugenden (z.B. "A la vÈritÈ" [= 20. nivÙse]) oder anderen Idealen
 * (z.B. "A l'Etre-SuprÍme" [= 10. vendÈmiaire]) widmete.
 * Der Beginn eines Jahres im Calendrier rÈpublicain wurde auf die Herbst - Tag-
 ...
 * Tage (in Schaltjahren 6) wurden als sogenannte "jours complÈmentaires"
