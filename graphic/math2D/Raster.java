...
public class Raster {
	...
	/** Generates a graphic Representation of the Nodes of this connected Component
	  ...
	  * Vermeide �berschneidungen (bei N Knoten mit ca. 4N Verbindungen ein 4N*N Problem!)
	  * N�herungsl�sung: verringere �berschneidungen (die in > 2D sowieso vorkommen)
	  * Nimm je 3 zusammenh�ngende Knoten und ermittle die geometrische L�sung.
	  * Ist die L�sung
	  * * Eindeutig, dann Koordinaten festlegen
	  * * zweideutig, dann �berspringen!
	  * * Unm�glich, z.B. wenn zwei Punkte schon festliegen,
	  *   setze den dritten (verl�ngere die Abst�nde gleichm��ig) derart,
