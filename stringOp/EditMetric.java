...
{	
	...
	//	Assert.EQUALS(4, metric.dist("Haus" , "H�us"   ), "Plural Umlaut Forms should be normalized!"); 
		Assert.EQUALS(1, metric.dist("Haus" , "H�us"   ), "Plural Umlaut Forms should be normalized!"); 
