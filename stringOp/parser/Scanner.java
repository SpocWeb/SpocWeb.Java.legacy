...
//implements IIStreamIn_Int 
{
	...
	*/
	...
	//						"Division(Name(HARDWARE)Name,Established(1994)Established,URL(http://www.icon-is.com/d/dev/hw/hw_main.asp)URL,Manager(TKEFE01)Manager,Desc(Entwicklung von kundenspezifischen mikroelektronischen Ger�ten.)Desc,Person(ID(TKEFE01)ID,LastName(Kefer)LastName,FirstName(Thomas)FirstName,Title(Dipl.-Ing.)Title,PhoneExt(41)PhoneExt,EMail(kefer@icon.at)EMail,)Person,)Division," +
