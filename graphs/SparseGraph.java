...
implements ITester { // only for
	 ...
	 * cannot be called twice! TODO: die Funktion ist fragw�rdig!!! sie geht z.B. gar
	 ...
	 */
	static final char[][] Sedgewick_30_2b = { // f�r zweifachen Zusammenhang
	...
	{'A', 'G', (char) 4}, {'C', 'A', (char) 1}, {'G', 'C', (char) 1},
			{'I', 'H', (char) 2}, // doppelt f�r gerichtete Graphen
			{'L', 'M', (char) 1}, // doppelt f�r gerichtete Graphen
	};
