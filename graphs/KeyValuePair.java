...
implements ICPair, IValue, ICopy, ITester { //, IPair {
	...
	public KeyValuePair(final Object _key) {  
		this.key = _key; }
	...
	/** Constructor with the full Information for a Pair
	  ...
	  */
	public KeyValuePair(final Object _key, final Object _value) {
		this.val = _value;
		this.key = _key; }
	
	/** reads all available Data from the ResultSet	 */
	public KeyValuePair(final ResultSet rs, final int[] cols) throws SQLException {
