...
/**
  * Growable, index-addressable array of primitive {@code char} elements, plus a large
...
extends AVector {
	 ...
	 */
	final static public char[] COLUMN(char[][] matrix, int col) {
		char[] ret = new char[matrix.length];
	 ...
	 */
	final static public char MAX(char[][] matrix, int col) {
	 ...
	 */
	final static public char[] MAP(final char[] a, final int[] index) {
	 ...
	 * even with Dimension Mismatch.
	 */
	final static public char[] MAP(final char[] a, final int[] index, char[] ret) {
		if((ret == null) || (ret.length < index.length))
			ret = new char[index.length];
	 ...
	 * @param mapping the List of Character Mappings to encode
	 * @param maxChar the maximum Character in the encoding
	 */
	final static public char[] MAP(char[][] mapping) {
		return MAP(mapping, MAX(mapping, 0)); }
	 ...
	 * @param maxChar the maximum Character in the encoding
	 */
	final static public char[] MAP(char[][] mapping, char maxChar) {
		char[] ret = Identity(maxChar+1);
		for(int i = mapping.length; --i >= 0; ) {
			ret[mapping[i][0]] = mapping[i][1]; } //
		return ret; 
	}
	 ...
	 */
	final static public char[] readVector(ResultSet RS,
		int numPointCol, int ColOffset, char[] Plane, char[] Cols)
		throws SQLException {
		if (!RS.next()) {
			return null; }
		int len;
		...
		try { //try to read as many Coordinates as possible!
			while (++i < len) {
				if (Cols == null) { //read consecutive Values
					Plane[i] = (char) RS.getInt(i+ColOffset);
				} else {
					Plane[i] = (char) RS.getInt(Cols[i]); }
			}
	 ...
	 */
	final static public char[] readVector(java.sql.ResultSet RS,
		int numPointCol,
		int ColOffset,
		char[] Plane)
	 ...
	 */
	final static public char MIN_VAL(final char[] arr) {
	 ...
	 * @return Minimum Value of the Array.
	 */
	final static public char MIN_VAL(final char[] arr, final int Start, int Stop) {
		char Min = Character.MAX_VALUE;
		while (--Stop >= Start) {
			if (Min > arr[Stop]) 
				Min = arr[Stop];
	 ...
	 */
	final static public int MIN_POS(final char[] arr) {
	 ...
	 * @return Minimum Value of the Array.
	 */
	final static public int MIN_POS(final char[] arr, final int Start, int Stop) {
		int iMin = -1;
	 ...
	 */
	final static public char MAX_VAL(final char[] arr) {
	 ...
	 * @return Maximum Value of the Array.
	 */
	final static public int MAX_POS(final char[] arr) {
	 ...
	 * @return Maximum Value of the Array.
	 */
	final static public char MAX_VAL(final char[] arr, final int Start, final int Stop) {
	 ...
	 */
	final static public int MAX_POS(final char[] arr, final int Start, int Stop) {
		int iMax = -1;
	 ...
	 */
	final static public char MIN (final char x, final char y) { return (x < y) ? x : y; }

	/**
	 * Returns the larger of the two given values.
	 * @return the Maximum of both Values
	 */
	final static public char MAX (final char x, final char y) { return (x > y) ? x : y; }
	
	/**Defines the Sqr for simple Types	 */
	final static public int SQR	(final char x) { return x*x; }
	
	/**Defines the Cbc for simple Types	 */
	final static public int CBC	(final char x) { return x*x*x; }
	
	/**Returns the Sign of x as an integer, i.e.
	 * -1 for negative x
	 *  0 for x == 0
	 * +1 for positive x	 */
	final static public char SIGN(final char x) {
		return (x > 0) ? (char) 1 : (char) 0; }
	...
	/** Returns the inverse Permutation in Place
	  ...
	  */
	public static char[] Inverse(char[] this_) {
		return Inverse(this_, new char[this_.length], this_.length); }

	/** Returns the inverse Permutation in Place
	  * @return the inverse Permutation
	  * Cannot be calculated in Place!
	  */
	public static char[] Inverse(char[] this_, int thisLength) {
		return Inverse(this_, new char[thisLength], thisLength); }
	
	/** Returns the inverse Permutation in Place
	 * @return the inverse Permutation in Place != this
	 * Cannot be calculated in Place!
	 */
	public static char[] Inverse(char[] this_, char[] ret) {
	 ...
	 * Cannot be calculated in Place!
	 */
	public static char[] Inverse(char[] this_, char[] ret, int thisLength) {
		while (--thisLength >= 0) {
			ret[this_[thisLength]] = (char) thisLength; }
		return ret; }
	...
	/** Reverts a complete Encoding Table for Bytes
	  ...
	  * @param length the maximum Character in the encoding
	  */
	final static public char[] Inverse(char[] encoding, char maxChar) {
		return Inverse(encoding, new char[maxChar+1], encoding.length); }
	...
	/** Reverts a complete Encoding Table for Bytes
	  ...
	  * @param length the maximum Character in the encoding
	  */
	final static public char[] FullInverse(char[] encoding) {
		return Inverse(encoding, Max(encoding)); }

	/** Returns the identical Permutation up to the given Length, i.e. id[i] = i
	 * @return the inverse Permutation in Place != this
	 * Cannot be calculated in Place!
	 */
	public static char[] Identity(int length) {
		return Identity(new char[length]); }

	/** Returns the identical Permutation in Place, i.e. id[i] = i
	 * @return the identical Permutation in Place 
	 */
	public static char[] Identity(char[] this_) {
		char len = (char) this_.length;
		while (len-- > 0) {
			this_[len] = len; }
		return this_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	/**final static public char[] permuteAt(char[] a, char[] perm) {
		char tmp;	//Undo the Row Permutations!
		int j, k = a.length;
	 ...
	 */
	public static char[] SET_AT(char[] arr, int Pos, char Value) {
		if (Pos >= arr.length) {
	...
	/** Returns a Copy of the given Array */
	public static char[] COPY(float[] arr) {
		final char[] ret = new char[arr.length];
...
//		System.arraycopy(arr, 0, ret, 0, arr.length); //doesn't work: "ArrayStoreException"
	...
	/** Returns a Copy of the given Array */
	public static char[] COPY(double[] arr) {
		final char[] ret = new char[arr.length];
		for (int i = arr.length; --i >= 0; ) 
			ret[i] = (char) arr[i]; 
//		System.arraycopy(arr, 0, ret, 0, arr.length); //doesn't work: "ArrayStoreException"
	...
	/** Returns a Copy of the given Array */
	public static char[] copyAt(char[] this_, char[] arr) {
		System.arraycopy(arr, 0, this_, 0, arr.length);
		return this_; }

	/** Returns a Copy of the given Array */
	public static char[] copyAt(char[] this_, char[] arr, int Start, int Stop) {
		System.arraycopy(arr, Start, this_, Start, Stop);
		return this_; }

	/** Returns a Copy of the given Array */
	public static char[] copyAt(char[] this_, double[] arr) {
		return copyAt(this_, arr, 0, arr.length); }

	/** Returns a Copy of the given Array */
	public static char[] copyAt(char[] this_, float[] arr) {
		return copyAt(this_, arr, 0, arr.length); }

	/** Returns a Copy of the given Array */
	public static char[] copyAt(char[] this_, double[] arr, int Start, int Stop) {
		int i = arr.length;
		while (--i >= 0) {
			this_[i] = (char) arr[i]; }
//		System.arraycopy(arr, Start, this_, Start, Stop); //ArrayTypeException!
	...
	/** Returns a Copy of the given Array */
	public static char[] copyAt(char[] this_, float[] arr, int Start, int Stop) {
		int i = arr.length;
		while (--i >= 0) {
			this_[i] = (char) arr[i]; }
//		System.arraycopy(arr, Start, this_, Start, Stop); //ArrayTypeException!
	 ...
	 */
	final static public char[][] setDimAt(char[][] a, int dim) {
		int i = a.length;
		while (--i >= 0) {
	...
	final static public char[] zeroAt(char[] ret, int Start, int Stop) {
	 ...
	 */
	final static public char[] oneAt(char[] a, int dim) {
		return diagAt(a, (char) 1, dim); }

	/**
	 * Setting to a diagonal Vector in Place using the Value given in diag,
	 * i.e. a[dim] = diag and a[j] = 0 otherwise.
	 */
	final static public char[] diagAt(char[] a, char diag, int dim) {
	...
	final static public char[] fillAt(char[] ret, char val) {
		return fillAt(ret, val, (char) 0, ret.length); }
	 ...
	 */
	final static public char[] fillAt(char[] ret, char val, int Start, int Stop) {
	 ...
	 */
	final static public boolean isZero(char[] arr) {
	 ...
	 */
	final static public boolean isZero(char[] arr, int Start, int Stop) {
		while (--Stop >= Start) {
			if (arr[Stop] != 0.0) {
				return false; }
		} return true; }
	 ...
	 */
	final static public boolean isOne(char[] Row, int dim) { 	//Assume a square Matrix
		int j  = Row.length;
     ...
     */
	final static public boolean between(char[] left, char[] mid, char[] right) {
		int i = left.length;
		while (--i >= 0) {
			if ((left [i] < mid[i]) !=
				(right[i] > mid[i])) {
	 ...
	 */
	final static public void orderAt(char[] inOutMin, char[] inOutMax) {
		char tmp;
...
////////////////////////////////////////////////////////////////////////////////
	...
	final static public long Sum(char[] arr) {
		return Sum(arr, 0, arr.length); }

	/**
	 * Returns the sum of the values in the given range of the array.
	 * @return The Sum of all Values in the Array.	 */
	final static public long Sum(char[] arr, int Start, int Stop) {
	...
	final static public long Prod(char[] arr) {
		return Prod(arr, 0, arr.length); }

	/**
	 * Returns the product of the values in the given range of the array.
	 * @return The Product of all Values in the Array.	 */
	final static public long Prod(char[] arr, int Start, int Stop) {
	 ...
	 * @return Minimum Value of the Array.
	 */
	final static public int Min(char[] arr) {
	 ...
	 * @return Minimum Value of the Array.
	 */
	final static public int Min(char[] arr, int Start, int Stop) {
	 ...
	 * @return Maximum Value of the Array.
	 */
	final static public char Max(char[] arr) {
	 ...
	 */
	final static public char Max(char[] arr, int Start, int Stop) {
		char Max = Character.MIN_VALUE;
		while (--Stop >= Start) {
			if (Max < arr[Stop]) {
				Max = arr[Stop]; }
	 ...
	 */
	final static public char[] MinMax(char[] arr) {
		return MinMax(arr, new char[2]); }
	 ...
	 * with the first two Elements filled with Minimum and Maximum.
	 */
	final static public char[] MinMax(char[] arr, char[] MinMax) {
		int i;
		char Min, Max;
	...
	/**
	  ...
	  */
	final static public double Norm(char[] arr) {
	...
	/**
	  ...
	  */
	final static public double SqrNorm(char[] arr) {
	...
	/**
	  ...
	  * @return the squared Norm of the given Array
	  */
	final static public long SqrNorm(char[] arr, int len) {
	...
	/**
	  ...
	  */
	final static public long SqrDist(char[] arr1, char[] arr2) {
	...
	/**
	  ...
	  */
	final static public int AbsVDist(char[] arr1, char[] arr2) {
	...
	/**
	  ...
	  * @return the squared Norm of the given Array
	  */
	final static public int AbsDiffNorm(char[] arr1, char[] arr2, char[] diff) {
		int dif;
		char norm = 0; //Calculate the Norm
		int i = arr1.length;
		while (--i >= 0) {
//			norm+=Math.abs(diff[i] = arr1[i]-arr2[i]); }
	...
	/**
	  ...
	  */
	final static public int AbsV_Norm(char[] arr) {
	...
	/**
	  ...
	  */
	final static public long ScalarProd(char[] arr1, char[] arr2) {
		int len = arr1.length;
		if (len > arr2.length) {
	...
	/**
	  ...
	  * @return the scalar Product of the given Arrays up to the given Length.
	  */
	final static public long ScalarProd(char[] arr1, char[] arr2, int start, int stop) {
		long ret = 0;
		while (--stop >= start) {
	...
	/**
	  ...
	  */
	final static public int MaxMinProd(char[] a, char[] arg) {
	...
	/**
	  ...
	  */
	final static public int MaxMinProd(char[] a, char[] arg, int start, int stop) {
	...
	/**
	  ...
	  */
	final static public char[] NegAt(char[] ret) {
	...
	/**
	  ...
	  */
	final static public char[] NegAt(char[] ret, int start, int stop) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] Neg(char[] ret, char[] x, int start, int stop) {
		while (--stop >= start) {
			ret[stop]  = (char) -x[stop]; }
		return ret; }
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] Neg(char[] ret, double[] x, int start, int stop) {
		while (--stop >= start) {
			ret[stop]  = (char) -x[stop]; }
		return ret; }
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] Neg(char[] ret, float[] x, int start, int stop) {
		while (--stop >= start) {
			ret[stop]  = (char) -x[stop]; }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] Neg(char[] x) {
		return Neg(new char[x.length], x, 0, x.length); }
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] Neg(char[] x, int start, int stop) {
		return Neg(new char[x.length], x, start, stop); }

	/**
	  * Returns a new char array containing the negation of the given double array.
	  * @return the Negative of the given Array
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] Neg(double[] x) {
		return Neg(new char[x.length], x, 0, x.length); }

	/**
	  * Returns a new char array containing the negation of the given range of the
	  * given double array.
	  * @return the Negative of the given Array
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  * @param start Index from  where the Array is processed
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] Neg(double[] x, int start, int stop) {
		return Neg(new char[x.length], x, start, stop); }

	/**
	  * Returns a new char array containing the negation of the given float array.
	  * @return the Negative of the given Array
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] Neg(float[] x) {
		return Neg(new char[x.length], x, 0, x.length); }
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] Neg(float[] x, int start, int stop) {
		return Neg(new char[x.length], x, start, stop); }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] AbsVAt(char[] ret) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] AbsVAt(char[] ret, int start, int stop) {
...
///////////////////////////////////////////////////////////////////////////////////
	...
	/**
	  ...
	  */
	final static public char[] MinAt(char[] ret, char Limit) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] MinAt(char[] ret, char Limit, int start, int stop) {
		while (--stop >= start) {
			if (ret[stop] > Limit) {
				ret[stop] = Limit; }
		} return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] MinAt(char[] ret, char[] arr) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] MinAt(char[] ret, char[] arr, int start, int stop) {
		while (--stop >= start) {
	...
	/**
	  ...
	  * @return the given Array incremented by the given Increment
	  */
	final static public char[] MaxAt(char[] ret, char Limit) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] MaxAt(char[] ret, char Limit, int start, int stop) {
		while (--stop >= start) {
			if (ret[stop] < Limit) {
				ret[stop] = Limit; }
		} return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] MaxAt(char[] ret, char[] arr) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] MaxAt(char[] ret, char[] arr, int start, int stop) {
		while (--stop >= start) {
			if (ret[stop] < arr[stop]) {
				ret[stop] = arr[stop]; }
		} return ret; }
	...
	/**
	  ...
	  * @return the given Array incremented by the given Increment
	  */
	final static public char[] addAt(char[] ret, int Increment) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] addAt(char[] ret, int Increment, int start, int stop) {
		while (--stop >= start) {
			ret[stop] += Increment; }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] addAt(char[] ret, char[] arr) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] addAt(char[] ret, char[] arr, int start, int stop) {
		while (--stop >= start) {
			ret[stop] += arr[stop]; }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] add(char[] ret, char[] sum1, char[] sum2) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] add(char[] ret, char[] sum1, char[] sum2, int start, int stop) {
		if (stop > ret .length) {
			stop = ret .length; }
		...
		if (stop > sum2.length) { System.arraycopy(sum1, sum2.length, ret, sum2.length, sum1.length - sum2.length);
			stop = sum2.length; }
		while (--stop >= start) {
			ret[stop] = (char) (sum1[stop] + sum2[stop]); }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] add(char[] ret, char[] sum1, int Incr) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] add(char[] ret, char[] sum1, int Incr, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (sum1[stop] + Incr); }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] add(char[] sum1, char[] sum2) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] add(char[] sum1, char[] sum2, int start, int stop) {
		return add(new char[stop], sum1, sum2, start, stop); }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] subAt(char[] ret, char[] arr) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] subAt(char[] ret, char[] arr, int start, int stop) {
		while (--stop >= start) {
			ret[stop] -= arr[stop]; }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] subt(char[] ret, char[] min, char[] sub) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] subt(char[] ret, char[] min, char[] sub, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (min[stop] - sub[stop]); }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] subt(char[] min, char[] sub) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] subt(char[] min, char[] sub, int start, int stop) {
		return subt(new char[stop], min, sub, start, stop); }
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] subt(char[] ret, double[] min, char[] sub, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (min[stop] - sub[stop]); }
		return ret; }
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] subt(char[] ret, float[] min, char[] sub, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (min[stop] - sub[stop]); }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] subt(double[] min, char[] sub) {
		return subt(min, sub, 0, sub.length); }
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] subt(double[] min, char[] sub, int start, int stop) {
		return subt(new char[stop], min, sub, start, stop); }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] subt(float[] min, char[] sub) {
		return subt(min, sub, 0, sub.length); }
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] subt(float[] min, char[] sub, int start, int stop) {
		return subt(new char[stop], min, sub, start, stop); }
	...
	/**
	  ...
	  */
	final static public char[] mulAt(char[] ret, int Factor) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] mulAt(char[] ret, int Factor, int start, int stop) {
		while (--stop >= start) {
			ret[stop] *= Factor; }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] mulAt(char[] ret, char[] arr) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] mulAt(char[] ret, char[] arr, int start, int stop) {
		while (--stop >= start) {
			ret[stop] *= arr[stop]; }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] mul(char[] ret, char[] min, char[] sub) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] mul(char[] ret, char[] min, char[] sub, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (min[stop] * sub[stop]); }
		return ret; }
	...
	/**
	  ...
	  */
	final static public char[] mul(char[] min, int factor) {
		return mul(new char[min.length], min, factor, 0, min.length); }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed.
	  */
	final static public char[] mul(char[] ret, char[] min, int factor) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] mul(char[] ret, char[] min, int factor, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (min[stop] * factor); }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] mul(char[] min, char[] sub) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] mul(char[] min, char[] sub, int start, int stop) {
		return mul(new char[stop], min, sub, start, stop); }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] divAt(char[] ret, char[] arr) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] divAt(char[] ret, char[] arr, int start, int stop) {
		while (--stop >= start) {
			ret[stop] /= arr[stop]; }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] div(char[] ret, char[] min, char[] sub) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] div(char[] ret, char[] min, char[] sub, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (min[stop] / sub[stop]); }
		return ret; }
	...
	/**
	  ...
	  * @param ret Array with the Values to be processed. Also returned by this Method.
	  */
	final static public char[] div(char[] min, char[] sub) {
	...
	/**
	  ...
	  * @param stop  Index up to where the Array is processed (not ret[stop]!)
	  */
	final static public char[] div(char[] min, char[] sub, int start, int stop) {
		return div(new char[stop], min, sub, start, stop); }
	...
	final static public char[] MaxMin(char[] ret, char[] a, char  y, int start, int stop) {
		char x; //FALSE; //can also start with any lower Value!
		while (--stop >= start) {
//			ret[stop] maxAt(a[stop] min b); } //equivalent and faster!
	...
	final static public char[] MaxMin(char[] ret, char[] a, char[] b, int start, int stop) {
		char  x, y; //FALSE; //can also start with any lower Value!
		while (--stop >= start) {
//			ret[stop] maxAt(a[stop] min b[stop]); } //equivalent and faster!
	 ...
	 * @return MaxMin Product of the two Vectors: ret maxAt(a min b)	  */
	final static public char[] MaxMin(char[] ret, char[] a, char[] b) {
	 ...
	 * @return MaxMin Product of the two Vectors: ret maxAt(a min y)	  */
	final static public char[] MaxMin(char[] ret, char[] a, char  y) {
...
//	final static public char[] addProdAt (char[] ret, int a, int y) {
	/**  Linear Mapping in Place: x-=a * y	 replaced by subAt(a*y)  */
//	final static public char[] subtProdAt(char[] ret, int a, int y) {
	/**BiLinear Mapping in Place: x*=a + y*b replaced by LinAt(a, y*b)  */
//	final static public char[] BiLinAt   (char[] ret, int a, int y, int b) {
	/**BiLinear Mapping in Place: x*=a + y*b replaced by LinAt(a, y*b)  */
//	final static public char[] BiLinAt   (char[] ret, char[] a, int y, int b) {

	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, char[] a, int y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] += a[stop] * y; }
		return ret; }

	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, char[] a, char[] y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] += a[stop] * y[stop]; }
		return ret; }

	/**  Linear Mapping in Place: x + a*y	 */
	final static public char[] addProd(char[] ret, char[] x, char[] a, char y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (x[stop] + a[stop] * y); }
		return ret; }

	/**  Linear Mapping in Place: x + a*y	 */
	final static public char[] addProd(char[] ret, char[] x, char[] a, char[] y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (x[stop] + a[stop] * y[stop]); }
		return ret; }

	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, double[] a, double y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] += a[stop] * y; }
		return ret; }

	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, float[] a, double y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] += a[stop] * y; }
		return ret; }

	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, int a, char[] y, int start, int stop) {
	...
	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, double a, double[] y) {
	...
	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, int a, char[] y) {
		return addProdAt (ret, a, y, 0, ret.length); }

	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, char[] a, int y) {
		return addProdAt (ret, a, y, 0, ret.length); }

	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProdAt (char[] ret, char[] a, char[] y) {
		return addProdAt (ret, a, y, 0, ret.length); }
	...
	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProd(char[] ret, char[] x, char a, char[] y) {
	...
	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProd(char[] x, char a, char[] y, int start, int stop) {
		return addProd(new char[stop], x, y, a, start, stop); }

	/**  Linear Mapping in Place: x += a*y	 */
	final static public char[] addProd(char[] x, char a, char[] y) {
		return addProd(new char[x.length], x, a, y, 0, x.length); }
	...
	/**  Linear Mapping in Place: x -= a*y	 */
	final static public char[] subtProdAt(char[] ret, char[] a, int y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] -= a[stop] * y; }
		return ret; }

	/**  Linear Mapping in Place: x -= a*y	 */
	final static public char[] subtProdAt(char[] ret, char[] a, char[] y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] -= a[stop] * y[stop]; }
		return ret; }

	/**  Linear Mapping in Place: x - a*y	 */
	final static public char[] subtProd(char[] ret, char[] x, char[] a, int y, int start, int stop) {
		while (--stop >= start) {
			ret[stop]  = (char) (x[stop] - a[stop] * y); }
		return ret; }

	/**  Linear Mapping in Place: x - a*y	 */
	final static public char[] subtProd(char[] ret, char[] x, char[] a, char[] y, int start, int stop) {
		while (--stop >= start) {
			ret[stop]  = (char) (x[stop] - a[stop] * y[stop]); }
		return ret; }

	/**  Linear Mapping in Place: x -= a*y	 */
	final static public char[] subtProdAt(char[] ret, int a, char[] y, int start, int stop) {
		return subtProdAt(ret, y, a, start, stop); }

	/**  Linear Mapping in Place: x -= a*y	 */
	final static public char[] subtProdAt(char[] ret, int a, char[] y) {
		return subtProdAt(ret, a, y, 0, ret.length); }

	/**  Linear Mapping in Place: x -= a*y	 */
	final static public char[] subtProdAt(char[] ret, char[] a, int y) {
		return subtProdAt(ret, a, y, 0, ret.length); }

	/**  Linear Mapping in Place: x -= a*y	 */
	final static public char[] subtProdAt(char[] ret, char[] a, char[] y) {
		return subtProdAt(ret, a, y, 0, ret.length); }

	/**  Linear Mapping: x - a*y	 */
	final static public char[] subtProd(char[] ret, char[] x, int a, char[] y, int start, int stop) {
		return subtProd(ret, x, y, a, start, stop); }

	/**  Linear Mapping: x - a*y	 */
	final static public char[] subtProd(char[] ret, char[] x, int a, char[] y) {
		return subtProd(ret, x, a, y, 0, ret.length); }

	/**  Linear Mapping: x - a*y	 */
	final static public char[] subtProd(char[] ret, char[] x, char[] a, int y) {
		return subtProd(ret, x, a, y, 0, ret.length); }

	/**  Linear Mapping: x - a*y	 */
	final static public char[] subtProd(char[] ret, char[] x, char[] a, char[] y) {
		return subtProd(ret, x, a, y, 0, ret.length); }

	/**  Linear Mapping: x - a*y	 */
	final static public char[] subtProd(char[] x, int a, char[] y, int start, int stop) {
		return subtProd(new char[stop], x, y, a, start, stop); }

	/**  Linear Mapping: x - a*y	 */
	final static public char[] subtProd(char[] x, int a, char[] y) {
		return subtProd(new char[x.length], x, a, y, 0, x.length); }

	/**  Linear Mapping: x - a*y	 */
	final static public char[] subtProd(char[] x, char[] a, int y) {
		return subtProd(new char[x.length], x, a, y, 0, x.length); }

	/**  Linear Mapping: x - a*y	 */
	final static public char[] subtProd(char[] x, char[] a, char[] y) {
		return subtProd(new char[x.length], x, a, y, 0, x.length); }


	/**  Linear Mapping in Place: x*=a + y	*/
	final static public char[] LinAt  (char[] ret, int a, int y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (ret[stop] * a + y); }
		return ret; }

	/**  Linear Mapping in Place: x*=a + y	*/
	final static public char[] LinAt  (char[] ret, char[] a, int y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (ret[stop] * a[stop] + y); }
		return ret; }

	/**  Linear Mapping in Place: x*=a + y	*/
	final static public char[] LinAt  (char[] ret, int a, char[] y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (ret[stop] * a + y[stop]); }
		return ret; }

	/**  Linear Mapping in Place: x*=a + y	*/
	final static public char[] LinAt  (char[] ret, char[] a1, char[] y, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (ret[stop] * a1[stop] + y[stop]); }
		return ret; }

	/**  Linear Mapping in Place: x*=a + y	*/
	final static public char[] LinAt  (char[] ret, int a1, int y) {
		return LinAt  (ret, a1, y, 0, ret.length); }

	/**  Linear Mapping in Place: x*=a + y	*/
	final static public char[] LinAt  (char[] ret, char[] a1, int y) {
		return LinAt  (ret, a1, y, 0, ret.length); }

	/**  Linear Mapping in Place: x*=a + y	*/
	final static public char[] LinAt  (char[] ret, int a1, char[] y) {
		return LinAt  (ret, a1, y, 0, ret.length); }

	/**  Linear Mapping in Place: x*=a + y	*/
	final static public char[] LinAt  (char[] ret, char[] a1, char[] y) {
		return LinAt  (ret, a1, y, 0, ret.length); }


	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, char[] a, char[] y, char[] b, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (x[stop] * a[stop] + y[stop] * b[stop]); }
		return ret; }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, char[] a, char[] y, int b, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (x[stop] * a[stop] + y[stop] * b); }
		return ret; }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, int a, char[] y, char[] b, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (x[stop] * a + y[stop] * b[stop]); }
		return ret; }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, int a, char[] y, int b, int start, int stop) {
		while (--stop >= start) {
			ret[stop] = (char) (x[stop] * a + y[stop] * b); }
		return ret; }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, char[] a, int y, char[] b, int start, int stop) {
		return BiLin(ret, x, a, b, y, start, stop); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, int a, char[] y, int b) {
		return BiLin(ret, x, a, y, b, 0, ret.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, char[] a, char[] y, int b) {
		return BiLin(ret, x, a, y, b, 0, ret.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, char[] a, char[] y, char[] b) {
		return BiLin(ret, x, a, y, b, 0, ret.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, int a, char[] y, char[] b) {
		return BiLin(ret, x, a, y, b, 0, ret.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] ret, char[] x, char[] a, int y, char[] b) {
		return BiLin(ret, x, a, y, b, 0, ret.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, char[] a, char[] y, char[] b, int start, int stop) {
		return BiLin(new char[x.length], x, a, b, y, start, stop); }

	/**BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, char[] a, char[] y, int b, int start, int stop) {
		return BiLin(new char[x.length], x, a, b, y, start, stop); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, int a, char[] y, char[] b, int start, int stop) {
		return BiLin(new char[x.length], x, a, b, y, start, stop); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, int a, char[] y, int b, int start, int stop) {
		return BiLin(new char[x.length], x, a, y, b, start, stop); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, char[] a, int y, char[] b, int start, int stop) {
		return BiLin(new char[x.length], x, a, b, y, start, stop); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, int a, char[] y, int b) {
		return BiLin(new char[x.length], x, a, y, b, 0, x.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, char[] a, char[] y, int b) {
		return BiLin(new char[x.length], x, a, y, b, 0, x.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, char[] a, char[] y, char[] b) {
		return BiLin(new char[x.length], x, a, y, b, 0, x.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, int a, char[] y, char[] b) {
		return BiLin(new char[x.length], x, a, y, b, 0, x.length); }

	/** BiLinear Mapping in Place: x*a + y*b */
	final static public char[] BiLin(char[] x, char[] a, int y, char[] b) {
		return BiLin(new char[x.length], x, a, y, b, 0, x.length); }

	/**BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, char[] a, char[] y, int b, int start, int stop) {
		return BiLin(ret, ret, a, b, y, start, stop); }

	/** BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, int a, char[] y, char[] b, int start, int stop) {
		return BiLin(ret, ret, a, b, y, start, stop); }

	/** BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, int a, char[] y, int b, int start, int stop) {
		return BiLin(ret, ret, a, y, b, start, stop); }

	/** BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, char[] a, int y, char[] b, int start, int stop) {
		return BiLin(ret, ret, a, b, y, start, stop); }

	/** BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, int a, char[] y, int b) {
		return BiLin(ret, ret, a, y, b, 0, ret.length); }

	/** BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, char[] a, char[] y, int b) {
		return BiLin(ret, ret, a, y, b, 0, ret.length); }

	/** BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, char[] a, char[] y, char[] b) {
		return BiLin(ret, ret, a, y, b, 0, ret.length); }

	/** BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, int a, char[] y, char[] b) {
		return BiLin(ret, ret, a, y, b, 0, ret.length); }

	/**BiLinear Mapping in Place: x*=a + y*b */
	final static public char[] BiLinAt(char[] ret, char[] a, int y, char[] b) {
		return BiLin(ret, ret, a, y, b, 0, ret.length); }
...
//		else
	...
	/**Constructs an empty VectorChar with the specified initial capacity
	 * and capacity increment.
	 *
	 * @param   initialCapacity	 the initial capacity of the VectorChar.
	 * @param   capacityIncrement   the amount by which the capacity is
	 *							  increased when the VectorChar overflows.	 */
	public VectorChar(final int initialCapacity, final int capacityIncrement_) {
		this.items = new char[initialCapacity];
	...
	/** Constructs an empty VectorChar with the specified initial capacity.
	  ...
	  *
	  * @param   initialCapacity   the initial capacity of the VectorChar.	 */
	public VectorChar(final int initialCapacity) {
		this(initialCapacity, DEFAULT_CAPACITY_INCR);
	}

	/** Constructs an empty VectorChar.
	  * Defaults the initial Capacity to 'defaultCapacityInit'.	 */
	public VectorChar() {
		this(DEFAULT_CAPACITY_INIT);
	}

	/** Constructs an VectorChar by copying from the given Object any Type.
	  * Defaults the Capacity Increment to 'defaultCapacityIncr'.	 */
	public VectorChar(final Object arg) {
		this(DEFAULT_CAPACITY_INIT, DEFAULT_CAPACITY_INCR);
		copyAt(arg);
	}

	/** Constructs an VectorChar from the given Object.	  */
	public VectorChar(final Object arg, final int capacityIncrement_) {
		this(DEFAULT_CAPACITY_INIT, capacityIncrement_);
		copyAt(arg);
	}

	/** Constructs an VectorChar from the given Object.	  */
	public VectorChar(final char[] arg, final int capacityIncrement_) {
		this(arg.length, capacityIncrement_);
		copyAt(arg);
	}

	/** Constructs an VectorChar from the given Object
	  * and copies the Elements into this VectorChar.	  */
	public VectorChar(char[] arg) {
	 ...
	 */
	final public VectorChar addItem(final char item) {
		setAt(itemCount, item);
		return this;
	}

	/**Copies the components of this VectorChar into the specified array.
	 * The array must be big enough to hold all the objects in this  VectorChar.
	 *
	 * @param   anArray   the array into which the components get copied.
	 * Declared final, because System.arraycopy is the fastest way.	 */
	final public synchronized void copyInto(char[] anArray) {
	 ...
	 *
	 * @param   anArray   the array into which the components get copied.	 */
	final public synchronized char[] toArray() {
		char[] Return = new char[itemCount];
		System.arraycopy(items, 0, Return, 0, itemCount);
		return Return;
	}

	/**Trims the capacity of this VectorChar to be the VectorChar's current
	 * size. An application can use this operation to minimize the
	 * storage of a VectorChar.	  */
	...
	/**Returns the current capacity of this VectorChar.
	 *
	 * @return  the current capacity of this VectorChar.	 */
	final public int getCapacity() {
		return items.length;
	}

	/**Increases the capacity of this VectorChar, if necessary, 
	...
	final public synchronized int setCapacity(final int minCapacity) {
		...
		final char[] oldData = items; items = new char[newCapacity];
		if (itemCount > 0) 
			System.arraycopy(oldData, 0, items, 0, itemCount);
		return newCapacity;
	}
	 ...
	 *			 given.	 */
	public synchronized char getCharAt(final int index) {
	 ...
	 */
	public char setAt(final int index, final char value) {
		char ret = 0; 
		if (indexInRange(index)) 
			ret = items[index];
		else 
	 ...
	 * @see		java.util.Array#size()
	 */
	public void insertAt(final int index, final char value) {
		if (index >= itemCount) { //
			setAt(index, value);
		} else {
	...
	public char getAt(final int Row, final int Col) {
		return items[Row * dimFactors[0] + Col * dimFactors[1]]; }

	/** sets the given Value 	 */
	public void setAt(final int Row, final int Col, final char Value) {
	 ...
	 * @return the Value at the given Position	 */
	public char getAt(final int Sheet, final int Row, final int Col) {
		return items[Sheet * dimFactors[0] + Row * dimFactors[1] + Col * dimFactors[2]]; }

	/** sets the given Value 	 */
	public void setAt(final int Sheet, final int Row, final int Col, final char Value) {
		items[Sheet * dimFactors[0] + Row * dimFactors[1] + Col * dimFactors[2]] = Value; }

	/**
	 * Returns the value at the given multi-dimensional index, viewing this vector's
	 * backing array as a rectangular multi-index array.
	 * @return the Value at the given Position	 */
	public char getAt(final int[] Col) {
		return items[multiIndex(Col)]; }

	/** sets the given Value 	 */
	public void setAt(final int[] Col, final char Value) {
	...
	public VectorChar copyAt(final char[] arg_) {
	...
	public ICopyAble copyAt(Object arg) {
		if (arg instanceof VectorChar) {
			VectorChar arg_ = (VectorChar) arg;
	...
	public ICopyAble newInstance() {
		return new VectorChar(items.length, capacityIncrement);
	}
	...
	/** adds the given Portion of the values to this Vector */
	public VectorChar addAt(final int value) {
		VectorChar.addAt(items, value, 0, itemCount);
		return this; }

	/** adds the given Portion of the values to this Vector */
	public VectorChar subAt(final int value) {
		VectorChar.addAt(items, -value, 0, itemCount);
		return this; }
	...
	public VectorChar mulAt(final char[] values, final int start, int stop) {
	...
	/** multiplies the given Portion of the values with this Vector */
	public VectorChar divAt(final char[] values, final int start, int stop) {
		while (values[--stop] == 0); //normalize 
		++stop;
		if (stop >= itemCount) {
			stop = itemCount; //all other Values are multiplied by 0
	...
	*/
	...
	/*	  public SemiGroupM mul(Object arg) {
			  if (arg instanceof Permutation) return new VectorChar(Permutation.map(Items, Items.length, (Permutation) arg), capacityIncrement);
			  if (arg instanceof char[]	  ) return new VectorChar(Permutation.map(Items, Items.length, (char[]	  ) arg), capacityIncrement);
	...
	*/
	 ...
	 */
	protected VectorChar(final char[] Values, final int[] Factors) {
	 ...
	 */
	/*	public VectorChar(int Rows, int Cols) {
			this.dimSizes = new char[2];
			this.dimSizes[0] = Cols;
			this.dimSizes[1] = Rows;
			dimFactors = new char[2];
			dimFactors[1] = 1;
			dimFactors[2] = Cols;
	...
	*/
	 ...
	 */
/*	public VectorChar(char[] Cols) {
		this.dimSizes = Cols;
		int Factor, i = Cols.length;
		dimFactors = new char[i];
...
*/
	...
	public VectorChar getTranspose() {
		...
		return new VectorChar(items, Factors);
	}
	...
	public static void testIt(String[] args) throws java.io.IOException {
		System.out.println("Testing " + VectorChar.class.getName());
	}
	...
	final static public Character[] const2Const(final char[] arg) {
		int len = arg.length;
		Character[] ret = new Character[len];
		while (--len >= 0)
			ret[len] = new Character(arg[len]);
		return ret; }
 ...
 * concepts: [Reverse-Order Char Stream Source]
 * facets: {layer: utility, status: legacy, complexity: low}
 * -->
 */
final class VectorCharStreamIn 
extends AVectorStreamIn_Int
{
	
	final VectorChar vector;

	/**
	 * Constructs a reverse-order iterator over the given vector's elements.
	 * @param vector_ the vector to iterate over
	 */
	public VectorCharStreamIn(final VectorChar vector_) {
